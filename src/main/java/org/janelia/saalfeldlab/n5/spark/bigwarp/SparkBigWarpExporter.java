package org.janelia.saalfeldlab.n5.spark.bigwarp;
...
public class SparkBigWarpExporter implements Callable< Void >
{
	...
	{
		new CommandLine(new SparkBigWarpExporter()).execute(args);
//		CommandLine cmd = new CommandLine( new SparkBigWarpExporter() );
	}
	
	public SparkBigWarpExporter() { }
